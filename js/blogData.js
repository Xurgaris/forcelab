...
export const POSTS = [
  {
    ...
    readingMinutes: 5,
    content: [
      { h2: "O que um pré-treino precisa entregar", p: "Foco, energia e consistência. O segredo é ajustar pela tolerância e evitar exageros." },
  ...
  },
  {
    ...
    content: [
      ...
      { h2: "Concentrado vs isolado", p: "Concentrado costuma ter melhor custo-benefício. Isolado ajuda quem tem sensibilidade." },
