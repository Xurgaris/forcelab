...
function clientKeyFromOrder(o) {
  ...
  const email = String(o.email || customer.email || "").trim().toLowerCase();
  const phone = normPhone(o.whatsapp || o.phone || o.telefone || customer.whatsapp);
...
async function fetchClients() {
  ...
  snap.forEach(doc => {
    ...
    const name = o.nome || o.name || customer.nome || "Cliente";
    const email = o.email || customer.email || "";
    const phone = o.whatsapp || o.phone || o.telefone || customer.whatsapp || "";
    const address = o.endereco || o.address || customer.endereco || "";
...
modal?.addEventListener("click", (e) => {
  if (e.target?.dataset?.close) openModal(false);
});
